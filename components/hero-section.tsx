...
>
<motion.h1
  className="mt-12 text-3xl lg:text-5xl font-bold text-white leading-snug tracking-tight space-y-2"
  initial={{ opacity: 0, y: 30 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 1.2, delay: 0.2 }}
>
  <div>Hi, I'm Ridhi Jolly.</div>
  <motion.div className="relative inline-block mt-2">
    <span className="text-orange-400">I build scalable, smart web platforms.</span>
    <motion.div
      className="absolute -inset-1 bg-orange-500/20 rounded-lg blur-xl -z-10"
      animate={{ opacity: [0.3, 0.6, 0.3] }}
      transition={{ duration: 2, repeat: Infinity }}
    />
  </motion.div>
